...
class ColranknewestDataScrapeSpider(scrapy.spiders.SitemapSpider):
    ...
    name = 'colranknewest_data_scrape'
    ...
    def close(spider, reason):
        ...
        collections_df = pd.read_csv('/Users/hans/Desktop/Files/Non-Monash/Business/Working/2022/Main/Naz - Dev Apps/scraper_csv_files/AWS-Tester/collections_ranking_newest.csv')
        collections_df.drop_duplicates(subset=['collection_id', 'app_ranking_list']).to_csv('/Users/hans/Desktop/Files/Non-Monash/Business/Working/2022/Main/Naz - Dev Apps/scraper_csv_files/collections_ranking_newest.csv', index=False)
